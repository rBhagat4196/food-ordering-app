...
const DBLeftSection = () => {
  return (
    <div className="h-full py-12 flex flex-col bg-lightOverlay backdrop-blur-md shadow-md min-w-210 max-w-300 gap-3">
      ...
      <div className="w-full items-center flex h-255 mt-auto px-2">
        <div className="w-[250px] h-full rounded-md bg-red-400 flex items-center justify-center flex-col gap-3 p-3">
            ...
            <p className="text-base text-gray-300 text-center">
                Having trouble in FlavorFleet. Please contact us for more questions 
            </p>
